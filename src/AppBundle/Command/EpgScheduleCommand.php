...
class EpgScheduleCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this->setName('app:epg:schedule')
            ->setDefinition([
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $epgScheduler = $this->getContainer()->get('app.epg_scheduler');
        ...
        $epgScheduler->schedule($channel, $startsAt, $endsAt);
